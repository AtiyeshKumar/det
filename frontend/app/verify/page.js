  ...
  return (
    <main className="min-h-screen bg-slate-900 flex flex-col items-center py-12 px-4">
      <div className="max-w-3xl w-full bg-slate-800/40 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border border-white/5">
        ...
        <p className="text-center text-slate-400 mb-6 text-lg">Upload evidence to verify authenticity with military-grade AI.</p>

        {/* ── Tab Switcher ── */}
        <div className="flex gap-2 p-1 bg-slate-900/60 rounded-xl mb-8 border border-white/5">
          <button
            id="tab-gemini"
          ...
          <button
            ...
            className={`flex-1 py-2.5 rounded-lg text-sm font-semibold transition-all
              ${activeTab === "deepfake"
                ? "bg-gradient-to-r from-purple-600 to-pink-500 text-white shadow-lg shadow-purple-900/30"
                : "text-slate-400 hover:text-white"
              }`}
          >
            🔬 Deepfake Scan
                  ...
                  <div className="flex-1 p-8 md:p-12 flex flex-col overflow-hidden relative z-20">
                    ...
                    <div className="mb-6 flex-shrink-0">
                      <div className="flex justify-between text-sm font-semibold text-slate-300 mb-2 font-mono">
                        ...
                        <span>{result.confidence_score ?? 0}%</span>
                      </div>
